...
class CfMakerCategory extends StatefulWidget {
  final String banner;
  final TabHomeModel model;

  const CfMakerCategory( this.banner, this.model);

  @override
  _CfMakerCategoryState createState() => _CfMakerCategoryState();
}

class _CfMakerCategoryState extends State<CfMakerCategory> {
  int value = 0;
          ...
          Row(
            children: <Widget>[
              Container(
                ...
                child: Text(
                  widget.model.getData.coffeeMaker.title,
                  style: TextStyle(
...
class _Tab1State extends State<Tab1> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.model.state == ViewState.Busy){
      ...
      children: List.generate(widget.model.getData.coffeeMaker.items.length,
              (index) {
            return Container(
              color: Colors.white,
              child: Column(
                children: <Widget>[
                  GestureDetector(
                    child: Container(
                      ...
                      child: FadeInImage.memoryNetwork(
                        image: 'https://trungnguyen.izysync.com/pub/media/catalog/product${widget.model.getData.coffeeMaker.items[index].mediaGalleryEntries[0].file}',
                        fit: BoxFit.contain,
                  ...
                  Container(
                    ...
                    alignment: AlignmentDirectional.center,
                    child: Text(
                      '${widget.model.getData.coffeeMaker.items[index].name}',
                      maxLines: 2,
                  ...
                  Container(
                    ...
                    alignment: AlignmentDirectional.center,
                    child: Text(
                      '${widget.model.formatMoney(widget.model.getData.coffeeMaker.items[index].price)} đ',
                    ),
                  ),
                ],
              ),
