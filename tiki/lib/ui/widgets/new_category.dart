...
class NewCategory extends StatefulWidget {
  ...
  const NewCategory( this.banner, this.model);
          ...
          Row(
            children: <Widget>[
              Container(
                ...
                child: Text(
                  widget.model.getData.homeProductNew.title,
                  style: TextStyle(
...
class _Tab1State extends State<Tab1> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.model.state == ViewState.Busy){
      ...
      children: List.generate(widget.model.getData.homeProductNew.items.length,
              (index) {
            return Container(
              color: Colors.white,
              child: Column(
                children: <Widget>[
                  GestureDetector(
                    child: Container(
                      ...
                      child: FadeInImage.memoryNetwork(
                        image: 'https://trungnguyen.izysync.com/pub/media/catalog/product${widget.model.getData.homeProductNew.items[index].mediaGalleryEntries[0].file}',
                        fit: BoxFit.contain,
                  ...
                  Container(
                    ...
                    alignment: AlignmentDirectional.center,
                    child: Text(
                      '${widget.model.getData.homeProductNew.items[index].name}',
                      maxLines: 2,
                  ...
                  Container(
                    ...
                    alignment: AlignmentDirectional.center,
                    child: Text(
                      '${widget.model.formatMoney(widget.model.getData.homeProductNew.items[index].price)} đ',
                    ),
                  ),
                ],
              ),
